...
(function (factory) {
  ...
  var factoryOutput = (() => {
    ...
    var B = (a) => F(L({}, "__esModule", { value: !0 }), a);
    var q = {};
    R(q, { Iti: () => I, default: () => G });
    var D = [
        ["af", "93"],
    ...
    var K = { ...N, ...A },
      T = K;
    for (let a = 0; a < y.length; a++) y[a].name = T[y[a].iso2];
    var U = 0,
      M = {
        allowDropdown: !0,
      ...
      $ = (a, t, e, i) => {
        ...
        for (let s = 0; s < t.length; s++) {
          if ((/[+0-9]/.test(t[s]) && n++, n === a && !i)) return s + 1;
          if (i && n === a + 1) return s;
        }
        return t.length;
      },
      ...
      I = class {
        ...
        _f() {
          ...
          if ((this.a.parentNode?.insertBefore(h, this.a), t || i || e)) {
            ((this.k = p("div", { class: "iti__country-container" }, h)),
            ...
            if (
              ((this.l = p("div", { class: "iti__flag" }, g)),
              ...
              if (
                ...
                (l
                  ? (f += " iti--fullscreen-popup")
                  : (f += " iti--inline-dropdown"),
                  (this.dropdown = p("div", { class: f })),
            ...
            (this._a12 = (l) => {
              ...
              if (e && !u && !m) {
                let h = this.a.selectionStart || 0,
                  ...
                  v = this._9(),
                  w = $(C, v, h, f);
                ((this.a.value = v), this.a.setSelectionRange(w, w));
              }
            }),
                  ...
                  if (t) {
                    let c = this.a.selectionStart === 0 && l.key === "+",
                      ...
                      C =
                        ...
                        g.length >= this.maxCoreNumberLength,
                      f = this.a.value.substring(
