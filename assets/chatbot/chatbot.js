...
jQuery(document).ready(function ($) {
  ...
  $(document).on("submit", "#messenger", function (e) {
    ...
    function userMsg(msg) {
      $('.messages_list').append('<div class="message new message-personal"><span class="avatar"><img src="../mrseankumar25.github.io/Sandeep-Kumar-Frontend-Developer-UI-Specialist/images/avatar.png" /></span><span class="responsText">' + mainval + '</span></div>');
    };
